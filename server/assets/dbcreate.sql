...
DROP TABLE users
cascade;
DROP TABLE mdv_events
cascade;
DROP TABLE mdv_locations
cascade;
DROP TABLE mdv_sheets
cascade;
DROP TABLE mdv_attendee_entries
cascade;
...
(
    ...
    sheet_date varchar(50) not null,
    created_on timestamp not null,
    created_by varchar(50) not null,
    updated_on timestamp not null,
    updated_by varchar(50) not null
...
(
    ...
    updated_by varchar
                ...
                (
                    sheet_id int
                    AUTO_INCREMENT PRIMARY KEY,
    event_id int not null REFERENCES mdv_event
                    (event_id),
    location_id int not null REFERENCES mdv_location
                    (location_id),
    sheet_date varchar
                    (50) not null,
    created_on timestamp not null,
    ...
    updated_by varchar
                    ...
                    (
                        entry_id int
                        AUTO_INCREMENT PRIMARY KEY,
    sheet_id int not null REFERENCES mdv_sheet
                        (sheet_id),
    entry_type varchar
                        (50) not null,
